...
object StaduConfig {
    // Capacity per block
    const val BLOCK_CAPACITY = 10 // Small for testing as per PDF example often uses small numbers, but requirement doesn't specify. Assuming 10-50 based on "12 blocks". Let's use 20.
    ...
    val ADJACENT_SECTORS = mapOf(
        ...
        SectorName.SOUTH to listOf(SectorName.EAST, SectorName.WEST), // Or West/East depending on geometry. Assuming square.
